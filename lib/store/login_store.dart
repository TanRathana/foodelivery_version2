...
import 'package:fooddelivery/view/verified.dart';
...
abstract class LoginStoreBase with Store {
  ...
  Future<void> getCodeWithPhoneNumber(BuildContext context, String phoneNumber) async {
    ...
    await _auth.verifyPhoneNumber(
        ...
        codeSent: (String verificationId, [int forceResendingToken]) async {
          ...
          isLoginLoading = false;
          await Navigator.of(context).push(MaterialPageRoute(builder: (_) => VerifiedPage()));
        },
  ...
  Future<void> signOut(BuildContext context) async {
    await _auth.signOut();
    await Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => const RegisterPage()), (Route<dynamic> route) => false);
    firebaseUser = null;
  }
}